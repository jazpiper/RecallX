...
export function renderActivitySearchResults(data: Record<string, unknown>): string;
export function renderWorkspaceSearchResults(data: Record<string, unknown>): string;
